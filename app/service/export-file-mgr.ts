 ...
 */
 ...
 export default class ExportFileMgr {
     /**
      * 四舍五入取整函数
      */
    public static rounded(f: number) {
         if (f == 0) {
             return 0
         }
         //return parseInt(f);
    ...
    public static escape_array(str: string) { 
     ...
     * @param {string} str 
     */
    public static escape_xml(str: string) {
        str = str.replace(/>/g, "&gt;")
        str = str.replace(/</g, "&lt;")
        str = str.replace(/"/g, "&quot;")
     ...
     * @param {string} str 
     */
    public static escape_lua(str: string) {
        str = str.replace(/&gt;/g, ">")
        str = str.replace(/&lt;/g, "<")
        // str = str.replace(/"(.*?)"/g, "“$1”")
        str = str.replace(/"(.*?)"/g, "\\\"$1\\\"")
    ...
    public static escape_csv(str: string) {
        str = str.replace(/&gt;/g, ">")
        str = str.replace(/&lt;/g, "<")
